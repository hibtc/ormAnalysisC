    ...
    def ormMeasured(self, plotShots=False):
        ...
        for k in range(len(self.kicks)):
            ...
            if(gridProfiles):
                ...
                #else:
                orbRErr_kx = np.sqrt(pOrmx[self.kickers[k]][1]**2
                                     + pOrmx[''][1]**2) / kickDiff
                orbRErr_ky = np.sqrt(pOrmy[self.kickers[k]][1]**2
                                     + pOrmy[''][1]**2) / kickDiff
...
class ORMOptimizer:
    ...
    def getMonitors(self):
        ...
        #monitors.append('t3dg1g')
        #monitors.append('t3dg2g')
        return monitors
    ...
    def initializeOrm(self, showPlots=False, plotShots=False):
        ...
        for mon_i in range(len(self.messFiles)):
            ...
            for k_i in range(len(kickers)):
                orbitResponse_x.append([mon_i, k_i, mMx[k_i],
                                        dmMx[k_i], mModelx[k_i]])
                orbitResponse_y.append([mon_i, k_i, mMy[k_i],
                                        dmMy[k_i], mModely[k_i]])
        ...
        for mon_i in range(len(self.messFiles)):
            ...
            for ele in fitData:
                ...
                if (mon_i == len(self.messFiles)-1):
                    ...
                    print('{} : {}'.format(ele.lower(), data[ele.lower()]))
